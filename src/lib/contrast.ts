// WCAG 2.1 relative-luminance contrast, used by design-tokens.test.ts to lock
// text/accent/semantic colours at AA (4.5:1) in both themes. Dependency-free and
...
/** WCAG contrast ratio (1–21) between two opaque hex colours. */
